...
v1Description = format "lineage.corpus" 1
  ...
  (fixture "basic.json" "Canonical minimal valid corpus." basicJSON valid ∷
   ...
   fixture "invalid-self-check-response.json" "Self-check response capture must be none." "{\"format\":\"lineage.corpus\",\"formatVersion\":1,\"corpusId\":\"invalid-self-check\",\"prompts\":[{\"id\":\"p\",\"revision\":1,\"challenge\":[\"Question\"],\"withheld\":[\"Answer\"],\"resolution\":[\"Answer\"],\"response\":{\"mode\":\"self-check\",\"capture\":\"text\"}}]}" (invalid "response.invalid-self-check" "/prompts/0/response/capture") ∷ [])
```
