...
export function ManualMemoryPage({
  ...
  const previewPrompt = actionData?.valid
      ...
      <div className={s.page}>
        ...
        <div className={s.layout}>
          <Form className={s.formCard} method="post">
            ...
            <label className={s.field}>
              ...
              <input
                ...
                required
              />
              <small>This identity is preserved across future revisions.</small>
            </label>
          ...
          <aside className={s.previewCard}>
            ...
            {actionData?.valid && previewPrompt ? (
              <>
              ...
              <div className={s.emptyPreview}>
                <p>
                  Complete the draft to see the exact challenge and resolution.
                </p>
              </div>
            )}
          </aside>
